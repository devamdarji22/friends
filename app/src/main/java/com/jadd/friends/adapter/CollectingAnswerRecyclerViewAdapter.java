...
public class CollectingAnswerRecyclerViewAdapter extends RecyclerView.Adapter<CollectingAnswerRecyclerViewAdapter.MyViewHolder> {

    Context context;
    ArrayList<User> names;

    public CollectingAnswerRecyclerViewAdapter(Context context, ArrayList<User> names) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if(names.get(position).isAnswered()){
